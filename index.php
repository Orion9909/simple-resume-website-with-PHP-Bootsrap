...
// user details
if(isLoggedIn()){
$fullname = getUserDetail('UserFirstname')." ".getUserDetail('UserLastname');
...
$fullname = "Joshua Cole";
$bday =  "August 3, 1975";
$age = calculateAge($bday);
$email = "example@gmail.com";
$phone = "9034239412";
$address = "Ormoc, Philippines";
}
?>
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <p>I'm a <span class="typed" data-typed-items="Graphic Designer, Web Developer, Game Developer"></span></p>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span><?php echo date( 'F d, Y', strtotime($bday)); ?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.example.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+63<?php echo $phone; ?></span></li>
